...
**নোট:** অ্যাপের অফিশিয়াল নাম রিলিজের পূর্বে চূড়ান্ত হবে। আপাতত টেকনিক্যাল স্পেক্সে এটিকে **[আমাদের অ্যাপ / The App]** হিসেবে উল্লেখ করা হয়েছে।  
...
### ৩.১ ১. ৩-স্তর বিশিষ্ট হাইব্রিড অ্যালগরিদম (3-Layer Hybrid Algorithm)

অ্যাপটিতে একক কোনো সাধারণ অ্যালগরিদম ব্যবহার না করে একটি **হাইব্রিড বা মিশ্র পদ্ধতি** ব্যবহার করা হবে। কারণ একেকটি লেয়ার গ্রাহকের আচরণ এবং ডেটা প্রসেসিংয়ের একেকটি দিক নিখুঁতভাবে সামলায়:

* **লেয়ার ১: রিয়েল-টাইম সেশন ও আচরণ (Real-Time Session & Behavior)**  
  * **কী ব্যবহার করা হবে:** রেডিস (Redis) ক্যাশিং এবং ইভেন্ট কিউ (Event Queue)।  
  * **কেন ব্যবহার করা হবে:** গ্রাহক যখন শপে ব্রাউজ করেন, তখন লাইভ ক্লিক, পেজ ভিউ এবং কার্টে পণ্য যোগ করার মতো ঘটনাগুলো মিলিসেকেন্ডের মধ্যে ট্র্যাক করা দরকার। রেডিস ইন-মেমোরি ডাটাবেস হওয়ায় এটি অত্যন্ত দ্রুত গতিতে কাজ করে, যার ফলে উইজেট লোড হতে কোনো ল্যাগ বা দেরি হয় না।
* **লেয়ার ২: ভেক্টর সিমিলারিটি ও কোলাবোরেটিভ ফিল্টারিং (Vector Similarity & Collaborative Filtering)**  
  * **কী ব্যবহার করা হবে:** পোস্টগ্রেসকিউএল (PostgreSQL)-এর সাথে `pgvector` এক্সটেনশন অথবা Pinecone এমবেডিং।  
  * **কেন ব্যবহার করা হবে:** "যাঁরা এই পণ্যটি কিনেছেন, তাঁরা এই পণ্যগুলোও দেখেছেন বা কিনেছেন" (Co-purchase pattern) এবং পণ্যের সাথে পণ্যের মিল (যেমন: স্টাইল, ট্যাগ বা ক্যাটাগরি) খুব নিখুঁতভাবে বের করতে ভেক্টর ডাটাবেসের জুড়ি নেই। এটি সাব-৫০ মিলি সেকেন্ডের মধ্যে বিশাল ক্যাটালগ থেকে সেরা ম্যাচিং পণ্যগুলো খুঁজে বের করতে পারে।
* **লেয়ার ৩: এলএলএম ইনটেন্ট ও এক্সপ্লেনাবিলিটি লেয়ার (LLM Intent & Explainability Layer)**  
  * **কী ব্যবহার করা হবে:** হালকা ও সাশ্রয়ী এলএলএম যেমন `gpt-4o-mini` বা Claude Haiku।  
  * **কেন ব্যবহার করা হবে:** ঐতিহ্যবাহী অ্যালগরিদমগুলো শুধু সংখ্যা বা মিল বোঝাতে পারে, কিন্তু মানুষের মতো কথা বলতে বা কারণ ব্যাখ্যা করতে পারে না। এলএলএম লেয়ারটি পণ্যের মেটাডেটা বিশ্লেষণ করে গ্রাহকের সামনে সহজ ভাষায় কারণ তুলে ধরে (যেমন: "কেন এই সুপারিশ?") এবং ন্যাচারাল ল্যাঙ্গুয়েজ সার্চে সাহায্য করে।
