...
### ৩.১ পার্ট ৩: প্রযুক্তিগত আর্কিটেকচার ও রিকমেন্ডেশন অ্যালগরিদম (৩-স্তর বিশিষ্ট হাইব্রিড আর্কিটেকচার)

সাব-৫০ মিলি সেকেন্ড লেটেন্সি বজায় রেখে গভীর পারসোনালাইজেশন নিশ্চিত করতে সিস্টেমটিতে একটি ৩-স্তর বিশিষ্ট হাইব্রিড আর্কিটেকচার ব্যবহার করা হয়েছে:

* **লেয়ার ১ (রিয়েল-টাইম সেশন ও আচরণ):** রেডিস (Redis) ক্যাশিং এবং ইভেন্ট কিউ-এর মাধ্যমে লাইভ ক্লিক, পেজ ভিউ এবং কার্ট অ্যাড তাৎক্ষণিকভাবে ট্র্যাক করে।
* **লেয়ার ২ (ভেক্টর সিমিলারিটি ও কোলাবোরেটিভ ফিল্টারিং):** PostgreSQL-এর সাথে `pgvector` অথবা Pinecone এমবেডিং ব্যবহার করে দ্রুত কো-পার্চেজ প্যাটার্ন এবং পণ্যের মিল গণনা করে।
* **লেয়ার ৩ (এলএলএম ইনটেন্ট ও এক্সপ্লেনাবিলিটি লেয়ার):** পণ্যের মেটাডেটাকে স্বাভাবিক ভাষার ব্যাখ্যায় ("কেন এই সুপারিশ?") রূপান্তর করে এবং ক্রেতাদের জন্য ন্যাচারাল ল্যাঙ্গুয়েজ প্রম্পট সার্চ পরিচালনা করে।
